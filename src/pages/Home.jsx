                ...
                <div className="container mx-auto px-4">
                    ...
                    <FadeUp>
                        <div className="mt-12 text-right">
                            <Link to="/properties" className="md:text-lg sm:text-base text-sm inline-block px-5 py-3 rounded-lg border border-black bg-black text-white hover:bg-white hover:text-black transition duration-300 ease-in-out">View All Properties</Link>
                        </div>
                    </FadeUp>
                </div>
            </section>
